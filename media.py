...
class Movie():
    ...
    Arguments:
        ...
        trailer_youtube_url: a string that stores the URL to the movie's trailer.
        ...
        * self: the constructor keyword referring to the instance/object created *
    """
            
    # define constructor function __init__(arguments)
    def __init__(self, movie_title, movie_storyline, poster_image, trailer_youtube, 
                 movie_release_year, movie_rating, movie_duration):
    ...
    def show_trailer(self):
        """ This instance method plays the youtube movie trailer in the web browser. """ 
