...
# import webbrowser module to open a website
import webbrowser
# import os module to use os.path() to open the output file in the browser
import os
  ...
  <body>
    ...
    <div class="modal" id="trailer">
      <div class="modal-dialog">
        ...
        <!-- Import the close button picture on the top right corner of the trailer modal -->
    ...
    <div class="container">
      ...
      <p>
          <div>Welcome to my <a href="#" style="color:white"><em>Fresh Tomatoes Movie Trailers</em></a> website!</div>
          <div>Explore this page by clicking on a movie poster to see its trailer.</div>
          <div>My favorite genres include:
          <div>
               <span>Drama</span>
               <span>-</span>
               <span>Comedy</span>
